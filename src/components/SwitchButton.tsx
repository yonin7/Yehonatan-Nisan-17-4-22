...
const DegreesSwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      transform: 'translateX(22px)',
      '& .MuiSwitch-thumb:before': {
        backgroundImage: `url(https://png.pngtree.com/png-clipart/20190630/original/pngtree-vector-celsius-icon-png-image_4159854.jpg)`,
  ...
  '& .MuiSwitch-thumb': {
    ...
    '&:before': {
      ...
      backgroundRepeat: 'no-repeat',
      backgroundPosition: 'center',
      backgroundImage: `url(https://png.pngtree.com/png-clipart/20190630/original/pngtree-vector-fahrenheit-icon-png-image_4159855.jpg)`,
      backgroundSize: 'contain',
    },
  },
  '& .MuiSwitch-track': {
